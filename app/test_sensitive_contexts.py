...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("API_KEY", "API Key AbCDef1234567890xyz", "AbCDef1234567890xyz"),
        ("API_KEY", "API_KEY\nAbCDef1234567890xyz", "AbCDef1234567890xyz"),
        ("API_KEY", "x-api-key AbCDef1234567890xyz", "AbCDef1234567890xyz"),
        ("API_KEY", "API 키 AbCDef1234567890xyz", "AbCDef1234567890xyz"),
